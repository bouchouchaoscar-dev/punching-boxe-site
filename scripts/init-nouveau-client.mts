...
log.todo("Schéma base : exécuter le schéma CONSOLIDÉ supabase/schema.sql dans Supabase (une seule fois, base vierge). NE PAS rejouer les migrations 001→010 une par une (= historique de Punching Boxe).");
