...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-line bg-paper-2 pt-28 sm:pt-36">
      <div
      ...
      />
      <div className="container-px relative mx-auto max-w-7xl pb-14 sm:pb-20">
        <Reveal>
